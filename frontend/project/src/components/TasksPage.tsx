...
const TasksPage: React.FC = () => {
    ...
    const fetchModelsAndDataChefs = async () => {
        ...
        try {
            ...
            if (modelsResponse.data) {
                const modelsArray = Object.values(
                    modelsResponse.data,
                ) as Model[];
    ...
    const handleUpdateTask = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (
                formData.dataChefId !== selectedTask.interactions_data_chef_id
            ) {
                updates.push(
                        ...
                        <div className="card-body">
                            ...
                            <div className="space-y-2 mb-4">
                                ...
                                <div className="flex items-center space-x-1 text-sm text-base-content/70">
                                    ...
                                    <span>
                                        Every {formatInterval(task.interval)}
                                    </span>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleUpdateTask} className="space-y-4">
                            ...
                            <div>
                                ...
                                {!loadingResources && models.length === 0 && (
                                    <p className="text-xs text-warning mt-1">
                                        No models found. Please create a model
                                        first.
                                    </p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {!loadingResources &&
                                    dataChefs.length === 0 && (
                                        <p className="text-xs text-warning mt-1">
                                            No data chefs found. Please create a
                                            data chef first.
                                        </p>
                                    )}
                            </div>
                            ...
                            <div>
                                <label className="label">
                                    <span className="label-text">
                                        Interval: {formData.interval} seconds (
