  ...
  try {
    ...
    try {
      ...
      const sampleProducts = [
        { id: 1, name: 'Product A', description: 'Description A', price: 100, category: 'electronics' },
        { id: 2, name: 'Product B', description: 'Description B', price: 200, category: 'clothing' },
        { id: 3, name: 'Product C', description: 'Description C', price: 150, category: 'electronics' },
        { id: 4, name: 'Product D', description: 'Description D', price: 80, category: 'books' },
        { id: 5, name: 'Product E', description: 'Description E', price: 250, category: 'electronics' }
      ];
...
app.get('/dashboard', requireAuth, async (req, res) => {
  ...
  const userLikes = userActions.filter(a => a.userId === req.session.user.id && a.action === 'like');
...
app.delete('/api/products/:id/like', requireAuth, async (req, res) => {
  ...
  const filteredActions = actions.filter(a =>
    !(a.userId === req.session.user.id && a.productId === productId && a.action === 'like')
  );
...
app.get('/api/recommendations', requireAuth, async (req, res) => {
  try {
    const modelId = req.query.model_id || 'my_model';
